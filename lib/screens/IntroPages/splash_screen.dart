...
class _SplashScreenState extends State<SplashScreen> {
       ...
       decoration: BoxDecoration(
        ...
        child: Column(
          ...
          children: [
           ...
           const Text("MONO",style: TextStyle(
             color: Colors.white,
 ...
 Future _navigator()async{
   ...
   await Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> OnboardScreen()));
  ...
  checkdata()async{
    ...
    nameisther==null?_navigator():Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> const BottomNavigator())) ;
  }
}